...
@Component({
  ...
  template: `
    ...
    <div class='iconSmall' [class.selected]="selectedIcon===2" (click)="router.navigate(['links']);selectedIcon=2">
    <img (error)="errorHandler($event)" src="./../assets/App icons/infinite-outline.png" style="width:30px;margin-top:5px;-webkit-filter:invert(100%)">
    </div>
