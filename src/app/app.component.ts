...
@Component({
  ...
  template: `
    ...
    <div class='iconSmall' [class.selected]="selectedIcon===1" (click)="router.navigate(['chat']);selectedIcon=1">
    ...
    <div class='iconSmall' [class.selected]="selectedIcon===2" (click)="router.navigate(['wallet']);selectedIcon=2">
